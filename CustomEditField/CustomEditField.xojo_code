		...
		Private Sub drawContents(gr as graphics, parentWindow as Window)
		      ...
		      if displayLineNumbers then
		        ...
		        if CaretLine = lineIdx then
		          ...
		          gg.DrawingColor = EditFieldGlobals.AdjustColorForDarkMode (&c000000)
		            ...
		            gg.DrawingColor =  EditFieldGlobals.AdjustColorForDarkMode (rgb(rnd * 255, rnd * 255, rnd * 255)) 'GutterBackgroundColor
		          #else
		            gg.DrawingColor =  GutterBackgroundColor
		          #endif
		          gg.FillRect 0,sy - g.TextHeight,LineNumOffset - 1 - FoldingOffset, TextHeight
		  ...
		  // paint visual block feedback
		    ...
		    if MouseOverBlock <> nil then
		      ...
		      gb.DrawingColor = EditFieldGlobals.AdjustColorForDarkMode (&c000000)
		      gb.FillRect 0, 0, blockPicture.Width, blockPicture.Height
		      
		      gb = blockPicture.Mask.Graphics
		      gb.DrawingColor = EditFieldGlobals.AdjustColorForDarkMode (&cAAAAAA)
		      gb.FillRect 0, 0, blockPicture.Width, blockPicture.Height
		      
		      gb.DrawingColor = EditFieldGlobals.AdjustColorForDarkMode (&cffffff)
		      ...
		      gb.DrawingColor = EditFieldGlobals.AdjustColorForDarkMode (&cA0A0A0)
		      gb.DrawRoundRect MouseOverBlock.value("x"), MouseOverBlock.Value("y"), MouseOverBlock.Value("w"), MouseOverBlock.Value("h"), 6,6
		      
		      gb.DrawingColor = EditFieldGlobals.AdjustColorForDarkMode (&C999999)
		      ...
		      gb.DrawingColor = EditFieldGlobals.AdjustColorForDarkMode (&C888888)
